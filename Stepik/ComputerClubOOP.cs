...
namespace Stepik
{
    ...
    //            Console.WriteLine($"У вас новый клиент, и он хочт купить {newClient.DesiredMinutes} минут.");
    ...
    //            }
    //            Console.WriteLine("Чтобы перейти к следующему клиента нажмите любую клавишу.");
    //            Console.ReadKey();
    //            Console.Clear();
